...
101	102	103
     * 
     */
    public class GasADObject2 : GeneralObject
    {

        public GasADObject2()
        {
            this.InitFinished += GasADObject2_InitFinished;
        }

        private void GasADObject2_InitFinished(object sender, RoutedEventArgs e)
        {
            this.PropertyChanged += GasADObject2_PropertyChanged;
            State = State.Loaded;
        }


        private void GasADObject2_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
