...
104	105	106
     */
    public class GasADObject3 : GeneralObject
    {

        public GasADObject3()
        {
            this.InitFinished += GasADObject3_InitFinished;
        }

        private void GasADObject3_InitFinished(object sender, RoutedEventArgs e)
        {
            this.PropertyChanged += GasADObject3_PropertyChanged;
            State = State.Loaded;
        }


        private void GasADObject3_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
