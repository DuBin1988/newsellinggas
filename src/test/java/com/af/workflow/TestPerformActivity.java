...
public class TestPerformActivity extends TestCase {
	public void testOne() throws Exception {
		String root = "http://127.0.0.1:8080/rs/";
		String personExpression = "[{data:{申请登记:'R(a)',a:'test',b:'test1'}}]";
        //String encoderJson = URLEncoder.encode(personExpression, HTTP.UTF_8);
		
		// 用httpclient直接访问服务
		HttpPost httpPost = new HttpPost(root + "workflow/perfomactivity/12345/system/2411083");
